...
class CreateDBTables:
    ...
    def create_users_table():
        ...
        while not success:
            ...
            if CreateDBTables.check_if_users_table_exist_in_db():
    ...
    def create_config_table():
        ...
        while not success:
            ...
            if CreateDBTables.check_if_config_table_exist_in_db():
                ...
                try:
                    ...
                    conn.commit()
                    CreateDBTables.insert_default_values_to_config_table()
    ...
    def run_create_tables():
        """ tables creation """
        CreateDBTables.create_users_table()
        CreateDBTables.create_config_table()


CreateDBTables.run_create_tables()
