...
class SendGetReqStopWebServers:

    def __init__(self, get_response):
        self.get_response = get_response

    def send_get_req_stop_web_server(self):

        get_response = self.get_response

        obj_build_stop_rest_server_url = ApplicationSettings
        url = obj_build_stop_rest_server_url.stop_server_web_app_url()
...
send_rest_stop_server_obj = SendGetReqStopWebServers(True)
send_rest_stop_server_obj.send_get_req_stop_web_server()
